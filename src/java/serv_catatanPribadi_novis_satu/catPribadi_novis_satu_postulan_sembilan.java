 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_novis_satu_postulan_sembilan", urlPatterns = {"/catPribadi_novis_satu_postulan_sembilan"})
public class catPribadi_novis_satu_postulan_sembilan extends HttpServlet {
        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_novis_satu_postulan_sembilan_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_novis_satu_postulan_sembilan.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
