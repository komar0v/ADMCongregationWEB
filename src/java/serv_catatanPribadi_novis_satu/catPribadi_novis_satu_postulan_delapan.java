 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_novis_satu_postulan_delapan", urlPatterns = {"/catPribadi_novis_satu_postulan_delapan"})
public class catPribadi_novis_satu_postulan_delapan extends HttpServlet {
        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_novis_satu_postulan_delapan_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_novis_satu_postulan_delapan.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
