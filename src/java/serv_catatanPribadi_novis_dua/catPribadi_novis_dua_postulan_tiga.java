 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_novis_dua_postulan_tiga", urlPatterns = {"/catPribadi_novis_dua_postulan_tiga"})
public class catPribadi_novis_dua_postulan_tiga extends HttpServlet {
        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                    </ul>\n"
                        + "                    <ul class=\"nav nav-tabs\">\n"
                        + "                        <li ><a href=\"./catPribadi_novis_dua_postulan_satu?id_suster="+datanya.getId_Suster()+"\">Novis 1-1</a></li>\n"
                        + "                        <li ><a href=\"./catPribadi_novis_dua_postulan_dua?id_suster="+datanya.getId_Suster()+"\">Novis 2-2</a></li>\n"
                        + "                        <li class=\"active\"><a href=\"\">Novis 3-3</a></li>\n"
                        + "                    </ul>\n"
                        + "\n"
                        + "\n"
                        + "                    <div class=\"tab-content\">\n"
                        + "                        <div class=\"tab-pane active\" id=\"home\">\n"
                        + "                            <form class=\"form\" action=\"./catPribadi_novis_dua_postulan_tiga_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_novis_dua_postulan_tiga.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
