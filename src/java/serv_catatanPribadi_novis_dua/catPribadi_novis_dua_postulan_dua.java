 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_novis_dua_postulan_dua", urlPatterns = {"/catPribadi_novis_dua_postulan_dua"})
public class catPribadi_novis_dua_postulan_dua extends HttpServlet {
        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                    </ul>\n"
                        + "                    <ul class=\"nav nav-tabs\">\n"
                        + "                        <li ><a href=\"./catPribadi_novis_dua_postulan_satu?id_suster="+datanya.getId_Suster()+"\">Novis 2-1</a></li>\n"
                        + "                        <li class=\"active\"><a href=\"#\">Novis 2-2</a></li>\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_novis_dua_postulan_dua_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_novis_dua_postulan_dua.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
