 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_novis_dua_postulan_sepuluh", urlPatterns = {"/catPribadi_novis_dua_postulan_sepuluh"})
public class catPribadi_novis_dua_postulan_sepuluh extends HttpServlet {
        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_novis_dua_postulan_sepuluh_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_novis_dua_postulan_sepuluh.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
