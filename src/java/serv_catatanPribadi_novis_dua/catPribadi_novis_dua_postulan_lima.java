 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_novis_dua_postulan_lima", urlPatterns = {"/catPribadi_novis_dua_postulan_lima"})
public class catPribadi_novis_dua_postulan_lima extends HttpServlet {
        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_novis_dua_postulan_lima_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_novis_dua_postulan_lima.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
