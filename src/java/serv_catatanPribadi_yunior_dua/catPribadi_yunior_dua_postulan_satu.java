 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_yunior_dua_postulan_satu", urlPatterns = {"/catPribadi_yunior_dua_postulan_satu"})
public class catPribadi_yunior_dua_postulan_satu extends HttpServlet {
        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_yunior_dua_postulan_satu_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_yunior_dua_postulan_satu.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
