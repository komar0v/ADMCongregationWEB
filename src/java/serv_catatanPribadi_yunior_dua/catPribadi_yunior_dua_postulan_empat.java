 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_yunior_dua_postulan_empat", urlPatterns = {"/catPribadi_yunior_dua_postulan_empat"})
public class catPribadi_yunior_dua_postulan_empat extends HttpServlet {
        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_yunior_dua_postulan_empat_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_yunior_dua_postulan_empat.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
