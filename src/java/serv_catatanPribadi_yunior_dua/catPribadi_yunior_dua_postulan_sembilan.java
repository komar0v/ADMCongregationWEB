        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                    </ul>\n"
                        + "                    <ul class=\"nav nav-tabs\">\n"
                        + "                        <li ><a href=\"./catPribadi_yunior_dua_postulan_satu?id_suster=" + datanya.getId_Suster() + "\"> 1</a></li>\n"
                        + "                        <li ><a href=\"./catPribadi_yunior_dua_postulan_dua?id_suster=" + datanya.getId_Suster() + "\"> 2</a></li>\n"
                        + "                        <li ><a href=\"./catPribadi_yunior_dua_postulan_tiga?id_suster=" + datanya.getId_Suster() + "\"> 3</a></li>\n"
                        + "                        <li ><a href=\"./catPribadi_yunior_dua_postulan_empat?id_suster=" + datanya.getId_Suster() + "\"> 4</a></li>\n"
                        + "                        <li ><a href=\"./catPribadi_yunior_dua_postulan_lima?id_suster=" + datanya.getId_Suster() + "\"> 5</a></li>\n"
                        + "                        <li ><a href=\"./catPribadi_yunior_dua_postulan_enam?id_suster=" + datanya.getId_Suster() + "\"> 6</a></li>\n"
                        + "                        <li ><a href=\"./catPribadi_yunior_dua_postulan_tujuh?id_suster=" + datanya.getId_Suster() + "\"> 7</a></li>\n"
                        + "                        <li ><a href=\"./catPribadi_yunior_dua_postulan_delapan?id_suster=" + datanya.getId_Suster() + "\"> 8</a></li>\n"
                        + "                        <li class=\"active\"><a href=\"#\"> 9</a></li>\n"
                        + "                        <li ><a href=\"./catPribadi_yunior_dua_postulan_sepuluh?id_suster=" + datanya.getId_Suster() + "\"> 10</a></li>\n"
                        + "                    </ul>\n"
                        + "\n"
                        + "\n"
