 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_yunior_dua_postulan_lima_save", urlPatterns = {"/catPribadi_yunior_dua_postulan_lima_save"})
public class catPribadi_yunior_dua_postulan_lima_save extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            PreparedStatement ps = con.prepareStatement("UPDATE catatanpribadi_yunior_dua_notes SET postulan5=? WHERE id_suster=?");
            ...
            try {
                ...
                out.println("location='./catPribadi_yunior_dua_postulan_lima?id_suster="+catatan.getId_suster()+"';");
                out.println("</script>");
