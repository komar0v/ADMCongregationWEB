        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                                <div class=\"form-group\">                                    \n"
                        + "                                    <div class=\"col-xs-6\">\n"
                        + "                                        <h4>Tempat Aspiran</h4>\n"
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"tempat_aspiran\" required value=\"" + datanya.getTempat_aspiran() + "\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">\n"
                        + "                                    <div class=\"col-xs-6\">\n"
                        + "                                        <h4>Tempat Postulat</h4>\n"
                        + "                                        <input type=\"text\" class=\"form-control\" name=\"tempat_postulat\" required value=\"" + datanya.getTempat_postulat() + "\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + ""
                        + "                                <div class=\"form-group\">\n"
