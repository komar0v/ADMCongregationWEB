        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                                        <input type=\"date\" class=\"form-control\" name=\"profesPertama\" required value=\""+datanya.getProfes_pertama()+"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "                                \n"
                        + "                                <div class=\"col-xs-12\">\n"
                        ...
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"tempatPembaruanPertama\" required value=\""+datanya.getTempat_pembaruan_pertama()+"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">\n"
                        ...
                        + "                                        <input type=\"date\" class=\"form-control\" name=\"tanggalPembaruanPertama\" required value=\""+datanya.getTanggal_pembaruan_pertama()+"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "                                \n"
                        + "                                <div class=\"form-group\">                                    \n"
                        ...
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"tempatPembaruanKedua\" required value=\""+datanya.getTempat_pembaruan_kedua()+"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">\n"
                        ...
                        + "                                        <input type=\"date\" class=\"form-control\" name=\"tanggalPembaruanKedua\" required value=\""+datanya.getTanggal_pembaruan_kedua()+"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "                                \n"
                        + "                                <div class=\"form-group\">                                    \n"
                        ...
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"tempatPembaruanKetiga\" required value=\""+datanya.getTempat_pembaruan_ketiga()+"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">\n"
                        ...
                        + "                                        <input type=\"date\" class=\"form-control\" name=\"tanggalPembaruanKetiga\" required value=\""+datanya.getTanggal_pembaruan_ketiga()+"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "                                \n"
                        + "                                <div class=\"form-group\">                                    \n"
                        ...
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"tempatKaulKekal\" required value=\""+datanya.getTempat_kaulkekal()+"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">\n"
                        ...
                        + "                                        <input type=\"date\" class=\"form-control\" name=\"tanggalKaulKekal\" required value=\""+datanya.getTanggal_kaulkekal()+"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "                                \n"
                        + "                                <div class=\"form-group\">\n"
