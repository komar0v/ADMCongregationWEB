        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                        <li ><a href=\"./minatBakat_suster?id_suster=#\">Minat Bakat</a></li>                \n"
                        + "                        <li ><a href=\"./riwayatPendidikan_suster?id_suster=#\">Riwayat Pendidikan</a></li>\n"
                        ...
                        + "                                    <h4>NIK Suster</h4>\n"
                        + "                                    <input type=\"text\"  class=\"form-control\" name=\"idSuster\" readonly value=\"#\">\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">                                    \n"
                        + "                                    <div class=\"col-xs-6\">\n"
                        + "                                        <h4>Paroki Asal</h4>\n"
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"parokiAsal\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">                                    \n"
                        ...
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"ukuranPakaian\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">                                    \n"
                        + "                                    <div class=\"col-xs-6\">\n"
                        + "                                        <h4>Tempat Baptis</h4>\n"
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"tempatBaptis\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">\n"
                        ...
                        + "                                        <input type=\"date\" class=\"form-control\" name=\"tanggalBaptis\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">                                    \n"
                        ...
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"tempatSakramenKrisma\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">\n"
                        ...
                        + "                                        <input type=\"date\" class=\"form-control\" name=\"tanggalSakramenKrisma\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">                                    \n"
                        ...
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"tempatKomuniPertama\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">\n"
                        ...
                        + "                                        <input type=\"date\" class=\"form-control\" name=\"tanggalKomuniPertama\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">                                    \n"
                        ...
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"tempatKleding\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">\n"
                        ...
                        + "                                        <input type=\"date\" class=\"form-control\" name=\"tanggalKleding\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"col-xs-12\">\n"
                        ...
                        + "                                        <input type=\"date\" class=\"form-control\" name=\"profesPertama\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "                                \n"
                        + "                                <div class=\"col-xs-12\">\n"
                        ...
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"tempatPembaruanPertama\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">\n"
                        ...
                        + "                                        <input type=\"date\" class=\"form-control\" name=\"tanggalPembaruanPertama\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "                                \n"
                        + "                                <div class=\"form-group\">                                    \n"
                        ...
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"tempatPembaruanKedua\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">\n"
                        ...
                        + "                                        <input type=\"date\" class=\"form-control\" name=\"tanggalPembaruanKedua\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "                                \n"
                        + "                                <div class=\"form-group\">                                    \n"
                        ...
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"tempatPembaruanKetiga\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">\n"
                        ...
                        + "                                        <input type=\"date\" class=\"form-control\" name=\"tanggalPembaruanKetiga\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "                                \n"
                        + "                                <div class=\"form-group\">                                    \n"
                        ...
                        + "                                        <input type=\"text\"  class=\"form-control\" name=\"tempatKaulKekal\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "\n"
                        + "                                <div class=\"form-group\">\n"
                        ...
                        + "                                        <input type=\"date\" class=\"form-control\" name=\"tanggalKaulKekal\" required value=\"\">\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "                                \n"
                        + "                                <div class=\"form-group\">\n"
