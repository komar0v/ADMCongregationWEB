 ...
 * @author ASUS
 */
@WebServlet(name = "editMinatBakat_suster", urlPatterns = {"/editMinatBakat_suster"})
public class editMinatBakat_suster extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String minatBkt = "";
            if (rs2.next()) {
                minatBkt = rs2.getString("minatbakat");
                
            }
            String arrminatBkt[] = minatBkt.split(",");
            ...
            try {
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                            \n"
                        + "                                   <form class=\"form\" action=\"./editMinatBakat_susterLakukanPerubahan\" method=\"POST\"> \n"
                        ...
                        + "                       <hr><h4>Edit minat bakat</h4><p>Jangan masukkan tanda koma (,) kedalam kolom</p> "
                                + "<div id=\"minat_bakat\">\n"
                                + "<table border=1>");
                out.println("<tr><th>Minat Bakat</th></tr>");
                for (int i = 0; i < arrminatBkt.length - 1; i++) {
                    
                    out.println("<tr><td><input type=\"text\" name=\"minatBakat_\" value=\""+arrminatBkt[i]+"\"></td></tr>");
                }
