...
@WebServlet(name = "ganti_fotoSuster_save", urlPatterns = {"/ganti_fotoSuster_save"})
public class ganti_fotoSuster_save extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Part filePart;
        filePart = request.getPart("foto_new");
        ...
        try {
            ...
            PreparedStatement PSeditphoto = conn.prepareStatement("UPDATE biodata_suster SET foto=? WHERE id_suster=?");
            PSeditphoto.setBlob(1, inputStream);
            PSeditphoto.setString(2, request.getParameter("idSuster"));
            PSeditphoto.executeUpdate();
            conn.close();

            try {
                out.println("<script type=\"text/javascript\">");
                out.println("alert('Berhasil ganti foto');");
                out.println("location='JavaScript:window.close()';");
                out.println("</script>");
            } finally {
                out.close();
            }
            ...
            Logger.getLogger(ganti_fotoSuster_save.class.getName()).log(Level.SEVERE, null, ex);
