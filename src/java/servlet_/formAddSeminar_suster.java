        ...
        try {
            ...
            try {
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                                    <h5>Jangan masukkan tanda koma (,) didalam kotak. Bila tidak ada sertifikat isi \"tidak ada\"</h5>"
                        + "                                <div class=\"field_wrapper\">\n"
                        + "                                    <div>\n"
                        + "                                        <input type=\"text\" name=\"seminar_suster1[]\" value=\"\" placeholder=\"nama seminar\" size=\"30\"/>\n"
                        + "                                        <input type=\"text\" name=\"seminar_suster2[]\" value=\"\" placeholder=\"nama sertifikat yang diterima\" size=\"30\"/>\n"
