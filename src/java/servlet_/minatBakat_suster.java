            ...
            try {
               ...
               for (int i = 1; i < arrMinatBakat.length; i++) {
                ...
                out.println("                     </div>\n"
                        ...
                        + "                                    <div class=\"col-xs-12\">\n"
                        + "                                        <br>\n"
                        + "                                        <button class=\"button icon solid\" formaction=\"./formAddMinatBakat_suster2?id_suster="+datanya.getId_Suster()+"\"><i class=\"glyphicon glyphicon-plus\"></i>TAMBAH MINAT BAKAT</button>\n"
