 ...
 * @author ASUS
 */
@WebServlet(name = "formAddMinatBakat_suster", urlPatterns = {"/minatBakat_suster"})
            ...
            try {
               ...
               for (int i = 1; i < arrMinatBakat.length; i++) {
                ...
                out.println("                     </div>\n"
                        ...
                        + "                                    <div class=\"col-xs-12\">\n"
                        + "                                        <br>\n"
                        + "                                        <button class=\"button icon solid\" formaction=\"./tambahMinatBakat_\"><i class=\"glyphicon glyphicon-upload\"></i>TAMBAH MINAT BAKAT</button>\n"
                        + "                                        <button class=\"button icon solid\" formaction=\"./tambahMinatBakat_\" type=\"reset\"><i class=\"glyphicon glyphicon-edit\"></i> EDIT MINAT BAKAT</button>\n"
                        + "                                    </div>\n"
                        + "                                </div>\n"
                        + "                            </form>\n"
                        + "                            <hr>\n"
