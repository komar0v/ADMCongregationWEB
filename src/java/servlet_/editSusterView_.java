        ...
        try {
            ...
            try {
                out.println("<!DOCTYPE html>\n"
                        ...
                        + "                                    <p>Klik disini untuk ganti foto <a target=\"popup\" onclick=\"window.open('./ganti_fotoSuster?id_suster=" + datanya.getId_Suster() + "','name','width=600,height=400')\" href=\"./ganti_fotoSuster?id_suster=" + datanya.getId_Suster() + "\">klik disini</a></p>"
