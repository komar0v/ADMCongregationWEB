 ...
 * @author ASUS
 */
@WebServlet(name = "ganti_pass_akun", urlPatterns = {"/ganti_pass_akun"})
public class ganti_pass_akun extends HttpServlet {
            ...
            try {
                ...
                try {
                    out.println("\n"
                            ...
                            + "        <div class=\"board\">\n"
                            + "\n"
                            + "            <form method=\"POST\" action=\"./do_simpanPasswordBaru\">\n"
                            + "                <input type=\"hidden\"  name=\"id_akun\" value=\"" + account.getId_akun() + "\">\n"
                            + "                <div class=\"form-group\">\n"
                            + "                    <label for=\"exampleInputEmail1\">Masukkan password baru</label>\n"
                            + "                    <input type=\"password\" class=\"form-control\" name=\"password_\" id=\"exampleInputEmail1\" value=\"\" aria-describedby=\"emailHelp\" placeholder=\"masukkan password baru\">\n"
                            + "                </div>\n"
