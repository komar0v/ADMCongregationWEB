        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                        <li class=\"active\" ><a data-toggle=\"tab\" href=\"#\">Tambah Riwayat Pendidikan</a></li>\n"
                        + "                    </ul>\n"
                        + "\n"
                        + "\n"
                        ...
                        + "                            <hr>\n"
                        + "                            <form class=\"form\" action=\"./tambahRiwayatPendidikan_suster\" method=\"GET\" id=\"registrationForm\">\n"
                        + "\n"
                        ...
                        + "                                    <div>\n"
                        + "                                        <input type=\"text\" id=\"inputan1\" name=\"riwayatPendidikan1[]\" value=\"\" placeholder=\"jenjang\" size=\"10\"/>\n"
                        + "                                        <input type=\"text\" id=\"inputan2\" name=\"riwayatPendidikan2[]\" value=\"\" placeholder=\"instansi\" size=\"30\"/>\n"
                        + "                                        <input type=\"text\" id=\"inputan3\" name=\"riwayatPendidikan3[]\" value=\"\" placeholder=\"tahun\" size=\"10\"/>\n"
                        ...
                        + "                var fieldHTML = '<div><input type=\"text\" name=\"riwayatPendidikan1[]\" id=\"inputan1\" value=\"\" placeholder=\"jenjang\" size=\"10\"/> <input type=\"text\" id=\"inputan2\" name=\"riwayatPendidikan2[]\" value=\"\" placeholder=\"instansi\" size=\"30\"/> <input type=\"text\" name=\"riwayatPendidikan3[]\" value=\"\" placeholder=\"tahun\" size=\"10\"/><a href=\"javascript:void(0);\" class=\"remove_button\"><img src=\"https://img.icons8.com/pastel-glyph/64/000000/minus.png\" width=\"25\" height=\"25\"></a></div>';\n"
