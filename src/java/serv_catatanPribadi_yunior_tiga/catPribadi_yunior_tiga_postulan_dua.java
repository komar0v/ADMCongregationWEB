        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_yunior_tiga_postulan_dua_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_yunior_tiga_postulan_dua.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
