 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_yunior_tiga_postulan_sepuluh", urlPatterns = {"/catPribadi_yunior_tiga_postulan_sepuluh"})
public class catPribadi_yunior_tiga_postulan_sepuluh extends HttpServlet {
        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_yunior_tiga_postulan_sepuluh_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_yunior_tiga_postulan_sepuluh.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
