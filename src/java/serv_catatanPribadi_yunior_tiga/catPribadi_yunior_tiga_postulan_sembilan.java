 ...
 */
package serv_catatanPribadi_yunior_tiga;
 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_yunior_tiga_postulan_sembilan", urlPatterns = {"/catPribadi_yunior_tiga_postulan_sembilan"})
public class catPribadi_yunior_tiga_postulan_sembilan extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps2 = conn.prepareStatement("SELECT * from catatanpribadi_yunior_tiga_notes WHERE id_suster=?");
            ...
            try {
                out.println("\n"
                        ...
                        + "                <li class=\"active\"><a href=\"#\">Yunior 3</a></li>"
                        + "                        \n"
                        + "                        \n"
                        + "                    </ul>\n"
                        + "                    <ul class=\"nav nav-tabs\">\n"
                        + "                        <li ><a href=\"./catPribadi_yunior_tiga_postulan_satu?id_suster=" + datanya.getId_Suster() + "\"> 1</a></li>\n"
                        + "                        <li ><a href=\"./catPribadi_yunior_tiga_postulan_dua?id_suster=" + datanya.getId_Suster() + "\"> 2</a></li>\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_yunior_tiga_postulan_sembilan_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_yunior_tiga_postulan_sembilan.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
