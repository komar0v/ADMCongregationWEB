 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_yunior_tiga_postulan_enam", urlPatterns = {"/catPribadi_yunior_tiga_postulan_enam"})
public class catPribadi_yunior_tiga_postulan_enam extends HttpServlet {
        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_yunior_tiga_postulan_enam_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_yunior_tiga_postulan_enam.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
