 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_yunior_satu_postulan_lima", urlPatterns = {"/catPribadi_yunior_satu_postulan_lima"})
public class catPribadi_yunior_satu_postulan_lima extends HttpServlet {
        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_yunior_satu_postulan_lima_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_yunior_satu_postulan_lima.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
