 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_yunior_satu_postulan_dua_save", urlPatterns = {"/catPribadi_yunior_satu_postulan_dua_save"})
public class catPribadi_yunior_satu_postulan_dua_save extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            PreparedStatement ps = con.prepareStatement("UPDATE catatanpribadi_yunior_satu_notes SET postulan2=? WHERE id_suster=?");
            ...
            try {
                ...
                out.println("location='./catPribadi_yunior_satu_postulan_dua?id_suster="+catatan.getId_suster()+"';");
                out.println("</script>");
