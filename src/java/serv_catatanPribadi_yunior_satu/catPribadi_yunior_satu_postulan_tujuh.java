 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_yunior_satu_postulan_tujuh", urlPatterns = {"/catPribadi_yunior_satu_postulan_tujuh"})
public class catPribadi_yunior_satu_postulan_tujuh extends HttpServlet {
        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_yunior_satu_postulan_tujuh_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_yunior_satu_postulan_tujuh.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
