 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_yunior_satu_postulan_tiga", urlPatterns = {"/catPribadi_yunior_satu_postulan_tiga"})
public class catPribadi_yunior_satu_postulan_tiga extends HttpServlet {
        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_yunior_satu_postulan_tiga_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_yunior_satu_postulan_tiga.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
