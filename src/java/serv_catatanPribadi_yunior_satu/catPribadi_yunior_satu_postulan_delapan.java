 ...
 * @author ASUS
 */
@WebServlet(name = "catPribadi_yunior_satu_postulan_delapan", urlPatterns = {"/catPribadi_yunior_satu_postulan_delapan"})
public class catPribadi_yunior_satu_postulan_delapan extends HttpServlet {
        ...
        try {
            ...
            try {
                out.println("\n"
                        ...
                        + "                        <li ><a href=\"./catPribadi_yunior_satu_postulan_sembilan?id_suster=" + datanya.getId_Suster() + "\"> 9</a></li>\n"
                        ...
                        + "                            <form class=\"form\" action=\"./catPribadi_yunior_satu_postulan_delapan_save\" method=\"POST\" id=\"registrationForm\">\n"
                        + "\n"
            ...
            Logger.getLogger(catPribadi_yunior_satu_postulan_delapan.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
