 ...
 * @author ASUS
 */
@WebServlet(name = "panel_berita", urlPatterns = {"/panel_berita"})
public class panel_berita extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cookies != null) {
            ...
            out.println("\n"
                    ...
                    + "        <h1>Panel Berita ADM</h1>\n"
                    + "        <h3>Selamat datang, "+nama_user+"</h3>        <div class=\"board\">\n"
                    + "\n"
                    + "            <section>\n"
                    + "                <div onclick=\"location.href='./tambah_berita';\" style=\"cursor: pointer;\" class=\"tile cover\">\n"
                    ...
                    + "\n"
                    + "            <section>\n"
                    + "                <div onclick=\"location.href='./lihat_berita_terpublish';\" style=\"cursor: pointer;\" class=\"tile cover\">\n"
                    ...
                    + "                </div>\n"
                    + "                <div class=\"tile desc\">\n"
                    + "                    <span>Panel berita untuk website ADM <br> dibuat di Yogyakarta</span>\n"
                    + "                </div>\n"
                    + "            </section>\n"
                    + "\n"
                    + "            <section>\n"
